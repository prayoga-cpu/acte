...
- [~] Interim beta/testing deploy on Vercel (both apps, personal Hobby team) instead — see D-013. TODO before this can be the real production host, or before any real firm sees it: decide Scaleway vs. Vercel vs. other for real; only synthetic data until then
